...
<body style="margin: 1px">
	<table id="dg" title="请假管理" class="easyui-datagrid" fitColumns="true"
		...
		url="${pageContext.request.contextPath}/leave/list.do?userId=${currentMemberShip.user.id}"
		fit="true" toolbar="#tb">
		<thead>
			<tr>
			...
			<table cellpadding="8px">
				...
				<tr>
					...
					<td><input type="hidden" name="user.id"
						value="${currentMemberShip.user.id }" /> <input type="hidden"
						name="state" value="未提交" /> <textarea type="text" id="leaveReason"
							name="leaveReason" rows="5" cols="49" class="easyui-validatebox"
