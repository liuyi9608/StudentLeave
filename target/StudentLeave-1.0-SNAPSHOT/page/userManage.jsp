...
<script type="text/javascript">
	...
	function openUserAddByExcelDiglog(){
		$("#dlg2").dialog("open").dialog("setTitle","通过excel添加用户信息");
		$("#flag").val(1);
		$("#id").attr("readonly",false);
	...
	function saveUserByExcel(){
		$("#fm").form("submit",{
			url:'${pageContext.request.contextPath}/user/saveByExcel.do',
			onSubmit:function(){
				return $(this).form("validate");
			},
			success:function(result){
...
<div id="tb">
 <div>
	...
	<a href="javascript:openUserAddByExcelDiglog()" class="easyui-linkbutton" iconCls="icon-add" plain="true">excel导入</a>
...
<div id="dlg2" class="easyui-dialog" style="width: 320px;height: 150px;padding: 10px 20px" closed="true" buttons="#dlg-buttons2">
 
 	<form id="fm" method="post" enctype="multipart/form-data"> 
 		<input type="file" name="userFile" class="easyui-validatabox" required="true" >		
 	</form>
...
<div id="dlg-buttons2">
	<a href="javascript:saveUserByExcel()" class="easyui-linkbutton" iconCls="icon-ok">保存</a>
	<a href="javascript:closeUserDialog()" class="easyui-linkbutton" iconCls="icon-cancel">关闭</a>
</div>
</body>
</html>