...
<script type="text/javascript">
	...
	function formatAction(val, row) {
		return "<a href='${pageContext.request.contextPath}/processDefinition/showView.do?deploymentId="
				+ row.deploymentId
				+ "&diagramResourceName="
				+ row.diagramResourceName + "' target='_blank'>查看流程图</a>"
	}
</script>
</head>
<body style="margin: 1px">
	<table id="dg" title="流程定义管理" class="easyui-datagrid" fitColumns="true"
		...
		url="${pageContext.request.contextPath}/processDefinition/list.do"
		fit="true" toolbar="#tb">
		<thead>
			<tr>
