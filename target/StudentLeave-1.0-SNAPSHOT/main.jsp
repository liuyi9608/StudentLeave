 ...
 <table style="padding: 5px;" width="100%">
 	<tr>
 		...
 		<td valign="bottom" align="right" width="50%">
 			...
 			<a href="javascript:logout()" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-exit'" style="width: ;">安全退出</a>
 		</td>
...
<div region="center" >
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			<div align="center" style="padding-top: 100px;"><font  size="10">欢迎来到学生请假系统</font></div>
		</div>
	</div>
</div>
